...
class grupo_horario(models.Model):
    ...
    fk_curso = models.ForeignKey(curso, on_delete=models.CASCADE)
    fk_docente = models.ForeignKey(docente, on_delete=models.CASCADE,null=True,blank=True)
    fk_ciclo_academico = models.ForeignKey(ciclo_academico, on_delete=models.CASCADE)
